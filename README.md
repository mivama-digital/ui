...
Applications install `@orevori/ui` directly as a pre-built, tree-shakeable package from npm. You do not need to copy and paste code via the shadcn CLI:
...
import { Toaster } from "@orevori/ui/toast"
...
```tsx
import { Button } from "@orevori/ui/button"
import { Card } from "@orevori/ui/card"
import { Field } from "@orevori/ui/field"
import { Input } from "@orevori/ui/input"
import { DataTable } from "@orevori/ui/data-table"
import { ChartContainer } from "@orevori/ui/chart"
```
...
Import `@orevori/ui/styles.css` once for the canonical aggregate stylesheet. It contains the self-hosted Onest variable font, Tailwind utilities, tokens, themes, and component styles.

Advanced consumers may import the lower-level stylesheets explicitly:

```ts
import "@orevori/ui/tokens.css"
import "@orevori/ui/themes.css"
```
