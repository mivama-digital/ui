...
function ComboboxContent({
  ...
  useShellAttributes("[data-slot=combobox-content]")

  return (
    <ComboboxPrimitive.Portal container={container ?? providerContainer}>
      ...
      >
        <ComboboxPrimitive.Popup
          ...
          data-chips={!!anchor}
          className={cn(
            "group/combobox-content relative max-h-96 w-(--anchor-width) max-w-(--available-width) min-w-[calc(var(--anchor-width)+--spacing(7))] origin-(--transform-origin) overflow-hidden rounded-md border bg-popover text-popover-foreground shadow-md outline-none",
