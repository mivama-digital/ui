...
try {
  ...
  await writeFile(
    ...
    [
      ...
      'import * as Root from "@mivama/ui";',
      'import { Button } from "@mivama/ui";',
      'import { Calendar } from "@mivama/ui/calendar";',
      'import { Carousel, CarouselNext, CarouselPrevious } from "@mivama/ui/carousel";',
      'import { ChartContainer, ChartTooltip, ChartTooltipContent } from "@mivama/ui/chart";',
      'import { Field, FieldLabel } from "@mivama/ui/field";',
      'import { Sidebar, SidebarTrigger } from "@mivama/ui/sidebar";',
      "",
